...
def main() -> None:
    ...
    parser.add_argument("--candidates-csv", default=str(DATA_DIR / "surrogate_optimization_balanced_candidates.csv"))
    parser.add_argument("--confirmation-csv", default=str(DATA_DIR / "surrogate_optimization_balanced_confirmation.csv"))
    parser.add_argument("--objective-column", default="balanced_score")
    parser.add_argument("--pinn-objective-column", default="pinn_peak_downward_abs")
    parser.add_argument("--fem-objective-column", default="fem_peak_downward_abs")
    parser.add_argument("--out-stem", default="fig_surrogate_optimization_balanced")
    parser.add_argument("--screening-title", default="PINN Screening Over 500 Designs (Balanced)")
    parser.add_argument("--confirmation-title", default="FEM Confirmation of Top Designs")
    parser.add_argument("--y-label", default="Balanced score / peak |$u_z$|")
